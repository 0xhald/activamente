defmodule ActivamenteWeb.Router do
  use ActivamenteWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {ActivamenteWeb.Layouts, :root}
  ...
  if Application.compile_env(:activamente, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: ActivamenteWeb.Telemetry
