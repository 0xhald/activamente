defmodule ActivamenteWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ActivamenteWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ActivamenteWeb.Gettext, "errors", msg, opts)
    end
  end
